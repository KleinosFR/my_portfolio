    ...
    return (
        ...
        <article>
            ...
            <Row className="left-align" >
                ...
                <Col l={10} s={12}>
                    <p>Since I was a teenager, I've always love to built things, above all understand how they are working. I was buying every week some magazines about electronics, and performing the tutorials I was encountering.
                    <br/>
                    ...
                    <ul style={{fontStyle:"italic"}}>
                        ...
                        <li>SMARS robot powered by an Arduino Uno</li>
                        <li>Web controlled valve to water my garden powered by a NodeMcu</li>
                        <li>Temperature, pressure, humidity sensors powered by a NodeMcu</li>
                        <li>A fork handler for my nephew who broked his both arms</li>
                        <li>Decoration and items for the events : Christmas, Easter, parties of the local Caribbean association...</li>
                    </ul>
