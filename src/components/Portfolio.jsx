...
import imgPj4 from "../assets/img/projectsImg/tracer-o.png";
import imgPj5 from "../assets/img/projectsImg/resolab.png";
...
const projectsList = [
    {
        ...
        name: "Wild Portfolio",
        description:
            "Portfolio of the Sept. 2019 students from the Wild Code School Biarritz ",
    ...
    },
    {
        ...
        description:
            "Project developped during a 24hrs hackathon. Winner of the hackathon",
    ...
    },
    {
        ...
        description:
            "Creation of the website for the delivery company TRACER-O",
        languages: "JS/React, Google Maps API, Reactstrap",
        image: imgPj4,
        url: "https://tracer-o.fr"
    },
    {
        id: 5,
        name: "Resolab",
        description:
            "Creation of a social network designed for children. Project for the account of Antic Pays-Basque, AdoEnia, Centre Hospitalier de la Côte Basque and DDEC64",
        languages:
            "JS/React, Redux, PHP, NodeJs / Express / socket.io, Material-UI, REST API",
        image: imgPj5,
        url: "https://resolab.netlify.com/"
    }
];
