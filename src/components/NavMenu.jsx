  ...
  <ul id="slide-out" className="sidenav white darken-3">
    <li>
      ...
      <div className="background grey ligthen-2">
        ...
        <a href="#intro"><img className="circle row" id="profilePic" src={profilePic} alt="profile picture"/></a>
    ...
    <li><a className="waves-effect blue-text text-lighten-2 sidenav-close" href="#about"> <i className="material-icons blue-text text-lighten-4">perm_identity</i>About me</a></li>
